...
<%
	String obj1frm10=session.getAttribute("sess1").toString();
//out.println("Text  have been converted to Speech successfully.");

SpeechToSpeechMain.TextToSpeech("Fin",obj1frm10, obj3frm7);
%>

<label style="margin-left: 5em"></label>
<%out.println("Output file created successfully at C:/Tanzeem VFoneSpain/Call for Code/OutPut Files"); %>
